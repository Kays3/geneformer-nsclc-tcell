...
This repo holds the NSCLC (LUAD/LUSC/normal) line of work, split out of the
original combined `geneformer-lung-tcell` repo. The SCLC line of work this
program's design mirrors — including the 24JSDP poster/talk — now lives in
its own repo: [`geneformer-sclc-tcell`](https://github.com/Kays3/geneformer-sclc-tcell).
